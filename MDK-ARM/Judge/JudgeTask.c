...
//	Referee_Transmit_UserData();
	  Referee_Transmit_graphic(1,935,600);
...
void Send_User_Data() {
    ...
    buffer[1] = 13;
    buffer[3] = 1;
    buffer[4] = Get_CRC8_Check_Sum(buffer, 5, CRC8_INIT);
    buffer[5] = 0x00;
    buffer[6] = 0x01;
...
//    }
   unsigned char * ph2 = (unsigned char*)&PowerHeat.shooter_id1_17mm_cooling_heat;
    ...
    RealHeat0 = PowerHeat.shooter_id1_17mm_cooling_heat;
    remainHeat0 = maxHeat0 - PowerHeat.shooter_id1_17mm_cooling_heat;
    remainHeat1 = maxHeat1 - PowerHeat.shooter_id1_42mm_cooling_heat;
    JUDGE_Received = 1;
}
...
void Referee_Transmit_UserData() {
    ...
    buffer[3] = 1;//包序号
    buffer[4] = Get_CRC8_Check_Sum(buffer, 5,CRC_INIT);//帧头 CRC8 校验
    buffer[5] = 0x03;
    buffer[6] = 0x01;
    ...
    static uint16_t CRC16=0;
    CRC16 = Get_CRC16_Check_Sum(buffer, 26,CRC_INIT);
...
void Referee_Transmit_graphic(uint8_t flag_ring,uint16_t x_ring,uint16_t y_ring) {
	  uint16_t datalength;
	  ...
	  GraphicData.dataFrameHeader.receiver_ID =(GameRobotState.robot_id | 0x0100);//客户端的ID，只能为发送者机器人对应的客户端
		...
		GraphicData.graphicData.graphic_data_struct[2].graphic_name[0]=102;
		GraphicData.graphicData.graphic_data_struct[2].operate_type=flag_ring;
	  GraphicData.graphicData.graphic_data_struct[2].graphic_type=2;
		GraphicData.graphicData.graphic_data_struct[2].layer=2;
		GraphicData.graphicData.graphic_data_struct[2].color=3;
		GraphicData.graphicData.graphic_data_struct[2].start_angle=0;
		GraphicData.graphicData.graphic_data_struct[2].end_angle=0;
		GraphicData.graphicData.graphic_data_struct[2].width=5;
		GraphicData.graphicData.graphic_data_struct[2].start_x=x_ring;
		GraphicData.graphicData.graphic_data_struct[2].start_y=1080-y_ring; 
		GraphicData.graphicData.graphic_data_struct[2].radius=22;
...
void Referee_Transmit_graphic_2(int a) {
	  ...
	  GraphicData.dataFrameHeader.receiver_ID =(GameRobotState.robot_id | 0x0100);//客户端的ID，只能为发送者机器人对应的客户端
		...
		GraphicData.graphicData.graphic_data_struct[0].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[0].graphic_name[1]=90	;
		GraphicData.graphicData.graphic_data_struct[0].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[0].graphic_type=0;
		...
		GraphicData.graphicData.graphic_data_struct[0].start_x=925;
		GraphicData.graphicData.graphic_data_struct[0].start_y=1080-915;
		GraphicData.graphicData.graphic_data_struct[0].radius=0;
		GraphicData.graphicData.graphic_data_struct[0].end_x=925;
		GraphicData.graphicData.graphic_data_struct[0].end_y=1080-647;
		
		GraphicData.graphicData.graphic_data_struct[1].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[1].graphic_name[1]=91	;
		GraphicData.graphicData.graphic_data_struct[1].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[1].graphic_type=0;
		...
		GraphicData.graphicData.graphic_data_struct[1].start_x=813;
		GraphicData.graphicData.graphic_data_struct[1].start_y=1080-916;
		GraphicData.graphicData.graphic_data_struct[1].radius=0;
		GraphicData.graphicData.graphic_data_struct[1].end_x=888;
		GraphicData.graphicData.graphic_data_struct[1].end_y=1080-647;
		
		GraphicData.graphicData.graphic_data_struct[2].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[2].graphic_name[1]=92	;
		GraphicData.graphicData.graphic_data_struct[2].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[2].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[2].layer=3;
		GraphicData.graphicData.graphic_data_struct[2].color=6;
		GraphicData.graphicData.graphic_data_struct[2].start_angle=0;
		GraphicData.graphicData.graphic_data_struct[2].end_angle=0;
		GraphicData.graphicData.graphic_data_struct[2].width=2;
		GraphicData.graphicData.graphic_data_struct[2].start_x=957;
		GraphicData.graphicData.graphic_data_struct[2].start_y=1080-647;
		GraphicData.graphicData.graphic_data_struct[2].radius=0;
		GraphicData.graphicData.graphic_data_struct[2].end_x=1030;
		GraphicData.graphicData.graphic_data_struct[2].end_y=1080-916;
		
		GraphicData.graphicData.graphic_data_struct[3].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[3].graphic_name[1]=93	;
	  ...
	  GraphicData.graphicData.graphic_data_struct[3].graphic_type=0;
		...
		GraphicData.graphicData.graphic_data_struct[3].start_x=755;
		GraphicData.graphicData.graphic_data_struct[3].start_y=1080-915;
		GraphicData.graphicData.graphic_data_struct[3].radius=0;
		GraphicData.graphicData.graphic_data_struct[3].end_x=1089;
		GraphicData.graphicData.graphic_data_struct[3].end_y=1080-915;
				
		GraphicData.graphicData.graphic_data_struct[4].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[4].graphic_name[1]=94	;
		GraphicData.graphicData.graphic_data_struct[4].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[4].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[4].layer=3;
		...
		GraphicData.graphicData.graphic_data_struct[4].width=3;
		GraphicData.graphicData.graphic_data_struct[4].start_x=815;
		GraphicData.graphicData.graphic_data_struct[4].start_y=1080-862;
		GraphicData.graphicData.graphic_data_struct[4].radius=0;
		GraphicData.graphicData.graphic_data_struct[4].end_x=1029;
		GraphicData.graphicData.graphic_data_struct[4].end_y=1080-862;
		
		GraphicData.graphicData.graphic_data_struct[5].graphic_name[0]=70	;
		GraphicData.graphicData.graphic_data_struct[5].graphic_name[1]=95	;
		GraphicData.graphicData.graphic_data_struct[5].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[5].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[5].layer=3;
		...
		GraphicData.graphicData.graphic_data_struct[5].width=3;
		GraphicData.graphicData.graphic_data_struct[5].start_x=815;
		GraphicData.graphicData.graphic_data_struct[5].start_y=1080-809;
		GraphicData.graphicData.graphic_data_struct[5].radius=0;
		GraphicData.graphicData.graphic_data_struct[5].end_x=1029;
		GraphicData.graphicData.graphic_data_struct[5].end_y=1080-809;
	  memcpy(	                                    
			CliendTxBuffer + 5,
			(uint8_t*)&GraphicData.CmdID, 
			(sizeof(GraphicData.CmdID)+ sizeof(GraphicData.dataFrameHeader)+ sizeof(GraphicData.graphicData))
...
void Referee_Transmit_graphic_3(int a) {
	  uint16_t datalength;
	  memset(CliendTxBuffer,0,128);
	  memset(&GraphicData,0,sizeof(ext_SendClientData_graphic_t));
	  GraphicData.txFrameHeader.SOF = 0xA5;
	  ...
	  GraphicData.dataFrameHeader.receiver_ID =(GameRobotState.robot_id | 0x0100);//客户端的ID，只能为发送者机器人对应的客户端
		...
		GraphicData.graphicData.graphic_data_struct[3].graphic_name[0]=80	;
		GraphicData.graphicData.graphic_data_struct[3].graphic_name[1]=93	;
		GraphicData.graphicData.graphic_data_struct[3].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[3].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[3].layer=3;
		...
		GraphicData.graphicData.graphic_data_struct[3].end_angle=0;
		GraphicData.graphicData.graphic_data_struct[3].width=3;
		GraphicData.graphicData.graphic_data_struct[3].start_x=815;
		GraphicData.graphicData.graphic_data_struct[3].start_y=1080-647;
		GraphicData.graphicData.graphic_data_struct[3].radius=0;
		GraphicData.graphicData.graphic_data_struct[3].end_x=1029;
		GraphicData.graphicData.graphic_data_struct[3].end_y=1080-647;
				
		GraphicData.graphicData.graphic_data_struct[4].graphic_name[0]=80	;
		GraphicData.graphicData.graphic_data_struct[4].graphic_name[1]=94	;
		GraphicData.graphicData.graphic_data_struct[4].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[4].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[4].layer=3;
		...
		GraphicData.graphicData.graphic_data_struct[4].width=3;
		GraphicData.graphicData.graphic_data_struct[4].start_x=815;
		GraphicData.graphicData.graphic_data_struct[4].start_y=1080-700;
		GraphicData.graphicData.graphic_data_struct[4].radius=0;
		GraphicData.graphicData.graphic_data_struct[4].end_x=1029;
		GraphicData.graphicData.graphic_data_struct[4].end_y=1080-700;
		
		GraphicData.graphicData.graphic_data_struct[5].graphic_name[0]=80	;
		GraphicData.graphicData.graphic_data_struct[5].graphic_name[1]=95	;
		GraphicData.graphicData.graphic_data_struct[5].operate_type=a;
	  GraphicData.graphicData.graphic_data_struct[5].graphic_type=0;
		GraphicData.graphicData.graphic_data_struct[5].layer=3;
		...
		GraphicData.graphicData.graphic_data_struct[5].width=3;
		GraphicData.graphicData.graphic_data_struct[5].start_x=815;
		GraphicData.graphicData.graphic_data_struct[5].start_y=1080-755;
		GraphicData.graphicData.graphic_data_struct[5].radius=0;
		GraphicData.graphicData.graphic_data_struct[5].end_x=1029;
		GraphicData.graphicData.graphic_data_struct[5].end_y=1080-755;
	  memcpy(	                                    
			CliendTxBuffer + 5,
			(uint8_t*)&GraphicData.CmdID, 
			(sizeof(GraphicData.CmdID)+ sizeof(GraphicData.dataFrameHeader)+ sizeof(GraphicData.graphicData))
...
void JUDEG_UI(void) {
		uint8_t UIflag=0;
	  char persent_x[5]={0},speed_x[5]={0};
		if(rc.key[15])
		{
			UIflag=1;
		}
    ...
    if(UIflag)
      ...
      UIflag=0;			
			...
			osDelay(100);
			Referee_Transmit_graphic_2(1);	
			osDelay(100);
			Referee_Transmit_graphic_3(1);	
			osDelay(100);
      Referee_Transmit_character_top(1,"ratate");
			osDelay(100);
			Referee_Transmit_character_wheel(1,"follow");
			osDelay(100);
			Referee_Transmit_character_AiMBot(1,"increase");
			osDelay(100);
			Referee_Transmit_character_bin_cover(1,"cover");
			osDelay(100);
			Referee_Transmit_character_rate(1,"speed");
			osDelay(100);
		...
		osDelay(100);	
		if(client_state_now.speed_CompensateCounter!=client_state_past.speed_CompensateCounter)
		{
		   itoa(client_state_now.speed_CompensateCounter,speed_x);
			 if(client_state_now.speed_CompensateCounter<0)
				 itoa(-client_state_now.speed_CompensateCounter,speed_x),
				 speed_x[1]=speed_x[0],speed_x[0]='-',speed_x[2]='\0';
			 else
				 itoa(client_state_now.speed_CompensateCounter,speed_x); 
			 Referee_Transmit_character_AiMBot(2,speed_x);
			 osDelay(100);
	  }
		if(client_state_now.shot_road_flag!=client_state_past.shot_road_flag)
		{
			switch(client_state_now.shot_road_flag)
			{
				case 0:
					Referee_Transmit_character_rate(2,"S:light");
					osDelay(100);
					break;
				case 1:
					Referee_Transmit_character_rate(2,"S:right");
					osDelay(100);
					break;
				case 2:
					Referee_Transmit_character_rate(2,"S:double");
					osDelay(100);
					break;
			}
//			client_state_past.speed_dial_shoot=client_state_now.speed_dial_shoot;
	  }
		if(client_state_now.ratate!=client_state_past.ratate)
		{
			switch(client_state_now.ratate)
			{
				case 0:
					Referee_Transmit_character_top(2,"ratate:off");
					osDelay(100);
					break;
				case 1:
					Referee_Transmit_character_top(2,"rotate:on");
					osDelay(100);
					break;
			}
//			client_state_past.motion=client_state_now.motion;
	}
		if(client_state_now.follow!=client_state_past.follow)
		{
			switch(client_state_now.follow)
			{
				case 0:
					Referee_Transmit_character_wheel(2,"follow:off");
					osDelay(100);
					break;
				case 1:
					Referee_Transmit_character_wheel(2,"follow:on");
					osDelay(100);
					break;
		  }
//			client_state_past.motion=client_state_now.motion;
		...
		if(client_state_now.bin_cover_of!=client_state_past.bin_cover_of)
		{
			switch(client_state_now.bin_cover_of)
			{
				case 1:
					...
					break;
				case 0:
					Referee_Transmit_character_bin_cover(2,"cover:closed");
					osDelay(100);
					break;
			}
